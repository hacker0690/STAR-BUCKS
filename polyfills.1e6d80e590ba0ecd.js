                ...
                class t {
                    ...
                    static any(u) {
                        ...
                        return new t((T, S) => {
                            for (let D = 0; D < s.length; D++) s[D].then(O => {
                                ...
                                b.push(O), f--, 0 === f && (g = !0, S(new E(b, "All promises were rejected")))
                            })
                        })
                    }
                    static race(u) {
                        ...
                        for (let S of u) B(S) || (S = this.resolve(S)), S.then(b, T);
                        return g
                    }
                    static all(u) {
                    ...
                    static allWithCallback(u, s) {
                        ...
                        for (let O of u) {
                            ...
                            try {
                                O.then(F => {
                                    D[V] = s ? s.thenCallback(F) : F, T--, 0 === T && f(D)
                                }, F => {
                                    s ? (D[V] = s.errorCallback(F), T--, 0 === T && f(D)) : g(F)
                                })
                            } catch (F) {
                                g(F)
                            }
                            ...
                            return function() {
                                ...
                                if ($)
                                    for (let _e = 0; _e < $.length; _e++)
                                        if (O === $[_e]) return fe ? s.call(D, O, V, se) : s.apply(this, arguments);
                                ...
                                const st = D.constructor.name,
                                    it = Ye[st];
                                it && (Se = it[O]), Se || (Se = st + f + (G ? G(O) : O)), h.options = se, nt && (h.options.once = !1), h.target = D, h.capture = xe, h.eventName = O, h.isExisting = ot;
                                const be = K ? ht : void 0;
                                be && (be.taskData = h);
                                const he = gt.scheduleEventTask(Se, V, be, g, b);
                                return h.target = null, be && (be.taskData = null), nt && (se.once = !0), !ye && "boolean" == typeof he.options || (he.options = se), he.target = D, he.capture = xe, he.eventName = O, F && (he.originalDelegate = V), S ? me.unshift(he) : me.push(he), T ? D : void 0
                            }
                        };
                    return p[c] = u(I, v, t, r, j), z && (p.prependListener = u(z, ".prependListener:", function(s) {
                        ...
                        if (O)
                            for (let V = 0; V < O.length; V++) {
                                const F = O[V];
                                if (C(F, T)) return O.splice(V, 1), F.isRemoved = !0, 0 === O.length && (F.allRemoved = !0, s[D] = null, "string" == typeof f) && (s[ke + "ON_PROPERTY" + f] = null), F.zone.cancelTask(F), j ? s : void 0
                            }
